...
class OnBoarding3Page extends StatefulWidget {
  ...
  @override
  State<OnBoarding3Page> createState() => OnBoarding3PageState();
}
...
class OnBoarding3PageState extends State<OnBoarding3Page> {
  ...
  void initState() {
    ...
    alcoholType = onboarding["alcoholType"] ??
        {
    ...
    tasteKeyword = onboarding["tasteKeyword"] ??
        {
          keyWordList[0]: false,
          keyWordList[1]: false,
          keyWordList[2]: false,
            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 33.0),
                  child: subTitleRow(
                      "images/icons/favorite.png", "입맛 키워드", "*여러개 선택 가능"),
                ),
                SizedBox(
                  height: 14,
                ),
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 33.0),
                  child: subTitleRow(
                      "images/icons/favorite.png", "좋아하는 주종", "*여러개 선택 가능"),
                ),
                SizedBox(
                  height: 14,
                ),
